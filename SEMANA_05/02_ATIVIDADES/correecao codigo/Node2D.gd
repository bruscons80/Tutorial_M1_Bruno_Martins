...
func _on_Button2_pressed():
	var NumeroAux = Numero #Declarei Numero = numero para nao ter que mudar muita coisa e mesmo assim ficar correto.
	for i in range(10):
		Numero += i
	lista.append(NumeroAux)
	$Label.text = str(NumeroAux) #Numero convertido em String para ser parte do LabelText
